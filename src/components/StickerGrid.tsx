  ...
  return (
    <div className="p-4">
      <button
        ...
        className="no-drag w-full mb-4 py-3 px-4 rounded-xl border-2 border-dashed border-primary-300 bg-primary-50 text-primary-600 hover:bg-primary-100 hover:border-primary-400 transition-all text-sm font-medium"
      >
        + 导入贴图
      </button>
